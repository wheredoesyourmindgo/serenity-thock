...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_grid(
        KC_TAB, KC_Q, KC_L, KC_C, KC_P, KC_B, KC_J, KC_F, KC_O, KC_U, KC_SCOLON, KC_BSPC,
	...
	[SYMBL] = LAYOUT_grid(
        ...
        MUTE_LP_HIDE, KC_NO, KC_NO, KC_NO, MO(NUMNAV), KC_SPC, KC_SPC, KC_NO, KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
	[AUX] = LAYOUT_grid(
        ...
        MUTE_LP_HIDE, KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), KC_SPC, LT(HRDWR,KC_SPC), MO(SYMBL), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
    [HRDWR] = LAYOUT_grid(
        ...
        KC_LSFT, RESET, DEBUG, KC_NO, KC_NO, KC_NO, TGL_LYT, KC_MRWD, KC_MFFD, KC_MPLY, KC_NO, KC_ENT,
        MUTE_LP_HIDE, KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), LT(AUX,KC_SPC), KC_SPC, MO(SYMBL), KC_NO, KC_NO, KC_NO, KC_NO
    ),
	[FUNC] = LAYOUT_grid(
